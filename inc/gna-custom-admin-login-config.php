<?php
if (!class_exists('GNA_Custom_AdminLogin_Config')) {
	class GNA_Custom_AdminLogin_Config {
		var $configs;
		var $message_stack;
		static $_this;
		...
		function load_config() {
			$this->configs = get_option('g_custom_adminlogin_configs');
		}
		...
		function save_config() {
			update_option('g_custom_adminlogin_configs', $this->configs);
		}
		...
		static function get_instance(){
			if(empty(self::$_this)){
				self::$_this = new GNA_Custom_AdminLogin_Config();
